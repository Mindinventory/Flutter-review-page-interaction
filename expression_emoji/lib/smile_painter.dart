...
import 'package:expression_emoji/review_state.dart';
import 'package:expression_emoji/text_animation.dart';
...
class SmilePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (slideValue <= 100 || slideValue > 300) {
      ...
      polygonPath.add(Offset(leftEyeX - eyeRadiusByTwo, eyeY - (eyeRadius+1)));
      ...
      polygonPath2.add(Offset(rightEyeX + eyeRadiusByTwo, eyeY - (eyeRadius+1.0)));
