...
class SmilePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    if (size != lastSize) {
      ...
      TextSpan spanGood = new TextSpan(style: new TextStyle(fontWeight: FontWeight.bold, fontSize: 52.0, color: okReview!.titleColor), text: "GOOD");
      TextPainter tpGood = new TextPainter(text: spanGood, textDirection: TextDirection.ltr);
      tpGood.layout();
...
//      ugh to ok
      ...
      canvas.drawOval(
          Rect.fromLTRB(leftEyeX - (eyeRadius! + eyeRadiusbythree!), eyeY - (eyeRadius! + eyeRadiusbythree!), leftTweenX!, leftTweenY!), whitePaint);

      canvas.drawOval(
          Rect.fromLTRB(rightTweenX!, eyeY, rightEyeX + (eyeRadius! + eyeRadiusbythree!), eyeY - (eyeRadius! + eyeRadiusbythree!)), whitePaint);
    }
...
//        Offset(endingX - oneThirdOfDiaByTwo, endingY), debugPaint);
  ...
  tweenText(ReviewState centerReview, ReviewState rightReview, double diff, Canvas canvas) {
    ...
    TextSpan spanCenter = new TextSpan(
        style: new TextStyle(fontWeight: FontWeight.bold, fontSize: 52.0, color: centerReview.titleColor.withAlpha(255 - (255 * diff).round())),
    ...
    TextSpan spanRight = new TextSpan(
        style: new TextStyle(fontWeight: FontWeight.bold, fontSize: 52.0, color: rightReview.titleColor.withAlpha((255 * diff).round())),
  ...
  Path getSmilePath(ReviewState state) {
    ...
    smilePath.quadraticBezierTo(state.leftHandle.dx, state.leftHandle.dy, state.centerOffset.dx, state.centerOffset.dy);
    smilePath.quadraticBezierTo(state.rightHandle.dx, state.rightHandle.dy, state.rightOffset.dx, state.rightOffset.dy);
    return smilePath;
  }
...
class ReviewState {
  ...
  ReviewState(this.leftOffset, this.leftHandle, this.centerOffset, this.rightHandle, this.rightOffset, this.startColor, this.endColor,
